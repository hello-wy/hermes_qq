...
export function loadConfig() {
  ...
  return {
    ...
    solidApiBaseUrl: getString("SOLID_API_BASE_URL", "https://solidapi.top/api/v1").replace(/\/+$/, ""),
    solidApiKey: getString("SOLID_API_KEY", ""),
    balanceAdminOnly: getBoolean("BALANCE_ADMIN_ONLY", true),
